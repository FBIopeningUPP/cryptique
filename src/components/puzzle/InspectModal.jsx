...
export default function InspectModal({
    ...
    return (                                                                                                                                                                                     
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 backdrop-blur-sm p-3 sm:p-6 select-none">                                                                  
          <div className="relative w-full max-w-4xl max-h-[92vh] flex flex-col bg-[#F7EFE1] border-4 border-[#543D2D] rounded-2xl shadow-[0_12px_40px_rgba(0,0,0,0.8)] overflow-hidden">           
