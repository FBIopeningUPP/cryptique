  ...
  return (                                                                                                                                                                                     
        <div className="fixed top-0 left-0 right-0 h-12 bg-[#2D1F17]/95 backdrop-blur-sm border-b-2 border-[#543D2D] z-40 px-4 sm:px-6 flex items-center justify-between shadow-md select-none">   
          ...
          <div className="flex items-center gap-2">                                                                                                                                                
            {onOpenCurios && (                                                                                                                                                                     
              <button                                                                                                                                                                              
                onClick={onOpenCurios}                                                                                                                                                             
                className="flex items-center gap-1.5 px-2.5 py-1 bg-[#3D2C20] hover:bg-[#4E3727] text-[#F4EBD9] border border-[#C59B4B]/60 rounded-lg text-xs font-serif transition active:scale-95 shadow-sm"                                                                                                                                                                                       
                title="Open Arthur's Curio Cabinet"                                                                                                                                                
              >                                                                                                                                                                                    
